...
export const AppIcon: React.FC<IconProps> = ({ size = 64 }) => {
  return (
    <Svg width={size} height={size} viewBox="0 0 1024 1024">
      ...
      {/* Smile */}
      <Path d="M 420 540 Q 512 600 604 540" stroke="#2D3436" strokeWidth="24" fill="none" strokeLinecap="round" />
      
      {/* Sparkle accent top left */}
      <Circle cx="280" cy="250" r="16" fill="#FFE680" />
      <Path d="M 272 230 L 272 270 M 260 250 L 300 250" stroke="#FFE680" strokeWidth="8" strokeLinecap="round" />
      
      {/* Sparkle accent top right */}
      <Circle cx="740" cy="260" r="12" fill="#FFD633" />
      <Path d="M 734 245 L 734 275 M 725 260 L 755 260" stroke="#FFD633" strokeWidth="6" strokeLinecap="round" />
    </Svg>
  );
};
